...
public class EventBus {
     ...
     */
    public <T, E extends Event<T>> void subscribe(E event, Listener<T> listener) {
     ...
     */
    public <T, E extends Event<T>> void subscribe(Class<E> eventClass, Listener<T> listener) {
     ...
     */
    public <T, E extends Event<T>> void unsubscribe(E event, Listener<T> listener) {
     ...
     */
    public <T, E extends Event<T>> void unsubscribe(Class<E> eventClass, Listener<T> listener) {
